...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h3 class="text-themecolor mb-0">Qcos Report </h3>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="form-group mb-0 mt-1 text-right">
                    ...
                    <a  href="{{ route("generateqcosreport") }}?shop_id={{ $shop_id }}&model_id={{ $model_id }}&joint_id={{ $joint_id }}&daterange={{ $daterange }}&type=print" target="_blank" class="btn btn-info btn-md text-white">Print</a>
