...
<div class="form-group row">
    ...
    <div class="custom-file">
        {!! Form::select('template_type', ['Specification'=>'Specification','Static'=>'Static','Measurement'=>'Measurement','Water-Leaks-Notes'=>'Water-Leaks-Notes','Running'=>'Running'],  null, ['placeholder' => 'Select Stage', 'class' => 'form-control custom-select ']); !!}   
    </div>
</div>
</div>
<div class="form-group row">
