...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="card-title m-0">CV Appearance &  Zones</h4>
                        <div>
                            <a href="{{ route('appearance-zones.edit', [$zonedata->id]) }}" class="h4 text-success" title="Add new field">
                                Edit
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>Zone</th>
                                    <th>Definition</th>
                                    <th>Applicable Portion</th>
                                  
                                </tr>
                            </thead>
                            
                            <tbody>
                                @foreach ($zonedata->zoneitems as $items)
                                    <tr>
                                        <td>{{ $items->zone }}</td>
                                        <td>{{ $items->defination }}</td>
                                        <td>{{ $items->applicable_portion }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <img src=" {{ asset('upload/qcos/' . $zonedata->image_one) }}" />
                            </div>
                            <div class="col-md-6 col-12">
                                <img src=" {{ asset('upload/qcos/' . $zonedata->image_two) }}" />
                            </div>
                        </div>
                        <hr />
                        <p class="font-weight-bold mt-2">Defect judgement methods</p>
                        <p> {!! $zonedata->note !!}</p>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <a href="{{ route('edit-instructions-cv', [$specification->id]) }}" class="h4 text-success" title="Add new field">
                                                        Edit
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <img src=" {{ asset('upload/qcos/' . $specification->image_one) }}" />
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <img src=" {{ asset('upload/qcos/' . $specification->image_two) }}" />
                                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <a href="{{ route('edit-instructions-cv', [$static->id]) }}" class="h4 text-success" title="Add new field">
                                                        Edit
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <img src=" {{ asset('upload/qcos/' . $static->image_one) }}" />
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <img src=" {{ asset('upload/qcos/' . $static->image_two) }}" />
                                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <a href="{{ route('edit-instructions-cv', [$measurement->id]) }}" class="h4 text-success" title="Add new field">
                                                        Edit
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <img src=" {{ asset('upload/qcos/' . $measurement->image_one) }}" />
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <img src=" {{ asset('upload/qcos/' . $measurement->image_two) }}" />
                                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <a href="{{ route('edit-instructions-cv', [$waterleaks->id]) }}" class="h4 text-success" title="Add new field">
                                                        Edit
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <img src=" {{ asset('upload/qcos/' . $waterleaks->image_one) }}" />
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <img src=" {{ asset('upload/qcos/' . $waterleaks->image_two) }}" />
                                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <a href="{{ route('edit-instructions-cv', [$running->id]) }}" class="h4 text-success" title="Add new field">
                                                        Edit
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <img src=" {{ asset('upload/qcos/' . $running->image_one) }}" />
                                                    </div>
                                                    <div class="col-md-6 col-12">
                                                        <img src=" {{ asset('upload/qcos/' . $running->image_two) }}" />
                                                    </div>
        ...
        @include('appearancezonescv.modal.add')
    @endsection
