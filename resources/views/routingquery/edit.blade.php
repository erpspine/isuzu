...
@section('content')
  ...
  <div class="content-header row pb-1">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="media width-250 float-right">
                        ...
                        <div class="media-body media-right text-right">
                            @include('routingquery.partial.routingquery-header-buttons')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Individual column searching (select inputs) -->
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                         ...
                                                         {!! Form::select('shop_id', $shops,  $routing_query->id, ['placeholder' => 'Select Shop', 'class' => 'form-control custom-select ']); !!}
                                                        </div>
                                                </div>
                                            </div>
       ...
       <option {{in_array($model->id, $modelid) ? 'selected':''}}> 
          {{$model->model_number}}
       </option>
        @endforeach
</select> 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                         ...
                                                         {!! Form::select('quiz_type', ['single'=>'Single Answer','multiple'=>'Multiple Answer','numeric'=>'Numerical Answer'],  $routing_query->quiz_type, ['placeholder' => 'Quiz Type', 'class' => 'form-control custom-select ']); !!}
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                        <textarea name="query_name[]" class="form-control" id="exampleTextarea" rows="3"
                ...
                success:function(result){
                    if(result.success == true){
                       ...
                       // capital_account_table.ajax.reload();
                        ...
                        location.href = '{{ route("routingquery.index") }}';
                    }else{
                         $("#submit-data").show();
