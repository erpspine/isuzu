@extends('layouts.app')
@section('title', 'Gca Defect Action List')
@section('content')
    <!-- ============================================================== -->
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h3 class="text-themecolor mb-0">Gca Defect Action List </h3>
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Gca Defect Action List</li>
            </ol>
        </div>
    ...
    <div class="container-fluid">
        <div class="content-header row pb-1">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="mb-0">Gca Defect Action List</h3>
            </div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                  ...
                  var tools = $('#tools').DataTable({
                    ...
                    //serverSide: true,
                    ajax: {
                        url: '{{ route('gcadefects-action.index') }}',
                        data: function(d) {
                ...
                $('table#tools tbody').on('click', 'a.delete-gca', function(e) {
                    e.preventDefault();
                    Swal.fire({
                        type: 'warning',
                        title: "Are You Sure",
                        ...
                        if (willDelete.value) {
                            ...
                            Swal.fire('Gca record  deleted', '', 'info')
                        }
                    });
                });
