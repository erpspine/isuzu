@extends('layouts.app')
@section('title', 'Gca Checksheet LCV Items')
@section('content')
    <!-- ============================================================== -->
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h3 class="text-themecolor mb-0">Gca LCV Checksheet Items </h3>
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Gca LCV  Checksheet Items - Template {{ $title->query_group_name }}</li>
            </ol>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            @if ($title->query_group_name == 'ABCD')
                ...
                <th>Zone D</th>
                            ...
                            @elseif ($title->query_group_name == 'No-Zones')
                                <table class="table table-striped table-bordered" id="routingquery">
                                    <thead>
                                        <tr>
                                            <th>Category</th>
                ...
                <th>Factor</th>
                            ...
                            @elseif ($title->query_group_name == 'Exterior-Interior')
                                <table class="table table-striped table-bordered" id="routingquery">
                                    <thead>
                                        <tr>
                                            <th>Category</th>
                            ...
                            @elseif ($title->query_group_name == 'Safety')
                                <table class="table table-striped table-bordered" id="routingquery">
                                    <thead>
                                        <tr>
                                            <th>Category</th>
                                ...
                                <table class="table table-striped table-bordered" id="routingquery">
                                    <thead>
                                        <tr>
                                            <th>Category</th>
                                            <th>Defect</th>
                                            <th>Safety / Government Regulation </th>
                                            <th>Non Safety / Government Regulation Labels </th>
                                            </th>
                                        </tr>
                                    </thead>
                                </table>
                            @elseif ($title->query_group_name == 'Weight Factor')
                                <table class="table table-striped table-bordered" id="routingquery">
                                    <thead>
                                        <tr>
                                            <th>Category</th>
                            ...
                            @elseif ($title->query_group_name == 'Fluid-Level')
                                <table class="table table-striped table-bordered" id="routingquery">
                                    <thead>
                                        <tr>
                                            <th>Category</th>
                                ...
                                @elseif ($title->query_group_name == 'Noise')
                                <table class="table table-striped table-bordered" id="routingquery">
                                    <thead>
                                        <tr>
                                            <th>Category</th>
