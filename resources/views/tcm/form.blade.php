                        ...
                        <div class="form-group row">
                            <label for="transducer_code" class="col-sm-4 text-right control-label col-form-label">TRANSDUCER CODE
                                     </label>
                            <div class="col-sm-8">
                                {{ Form::text('transducer_code', null, ['class' => 'form-control', 'placeholder' => 'TRANSDUCER CODE', 'autocomplete' => 'off']) }}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="torque_setting_value" class="col-sm-4 text-right control-label col-form-label">TORQUE SETTING VALUE
                                     </label>
                            <div class="col-sm-8">
                                {{ Form::text('torque_setting_value', null, ['class' => 'form-control', 'placeholder' => 'TORQUE SETTING VALUE', 'autocomplete' => 'off']) }}
                            </div>
                        </div>
                        <div class="form-group row">
