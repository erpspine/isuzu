                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::select('shop_id',$shops, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'shop_id', 'placeholder' => 'Select Shop']); !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                {!! Form::label('status',  'Status:') !!}
                                {!! Form::select('status', ['OK'=>'OK','NOK'=>'NOK'], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'status', 'placeholder' => 'Status']); !!}
                            </div>
                        </div>
    ...
    @section('after-scripts')
       ...
       var tools = $('#tools').DataTable({
        ...
        buttons: [
            ...
            $(document).on('change', '#shop_id, #status', 
                function() {
