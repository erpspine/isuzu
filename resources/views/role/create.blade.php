        ...
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'change-defect-inputs', false,
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                ...
                <div class="card-body">
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gcaboard-create', false,
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'gcaboardcreate']); !!}
                        <label for="gcaboardcreate">Create  Board</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gcaboard-followup', false,
        ...
        <div class="col-3">
            <h5 class="ml-3">QCOS  Module Calibration:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
    ...
    <div class="col-lg-12">
        <div class="card border-left border-right border-info">
            <div class="card-body">
				...
				<div class="mb-2">
                    {!! Form::checkbox('permissions[]', 'plant-attendance', false,
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card border-left border-right border-info">
            <div class="card-body">
                <div class="mb-2">
                    {!! Form::checkbox('permissions[]', 'gca-report-defects', false,
                        [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'gcadefects']); !!}
                    <label for="gcadefects">Defect</label>
                </div>

                <div class="mb-2">
                    {!! Form::checkbox('permissions[]', 'gca-report-dpvwdpv', false,
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                ...
                <div class="card-body">
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-list-list', false,
                    ...
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-list-create', false,
                    ...
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-list-edit', false,
                    ...
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-list-delete', false,
        ...
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                ...
                <div class="card-body">
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-model-list', false,
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'material-management-model-create']); !!}
                        <label for="material-management-model-create">List </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-model-create', false,
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'material-management-model-create']); !!}
                        <label for="material-management-model-create">Create  </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-model-edit', false,
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'material-management-model-edit']); !!}
                        <label for="material-management-model-edit">Edit </label>
                    </div>

                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-model-delete', false,
