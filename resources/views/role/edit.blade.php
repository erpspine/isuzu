...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            ...
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active">Edit Role and Permissions</li>
            </ol>
        </div>
  ...
  <div class="content-header row pb-1">
    ...
    <div class="card-header bg-primary mb-2">
        <h3 class="text-white">EDIT ROLE & PERMISSIONS </h3>
    </div>
    <div class="row">
    <div class="col-md-4">
        ...
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'change-defect-inputs', in_array('change-defect-inputs',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'changedefectinputs']); !!}
                        <label for="changedefectinputs">Change Input </label>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-3">
            <h5 class="ml-3">GCA Board  Module:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">

                <div class="card-body">
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gcaboard-create', in_array('gcaboard-followup',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'gcaboardcreate']); !!}
                        <label for="gcaboardcreate">Create  Board</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gcaboard-followup', in_array('gcaboard-followup',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'gcaboardfollowup']); !!}
                        <label for="gcaboardfollowup">Create Follow UP Item </label>
                    </div>
        ...
        <div class="col-3">
            <h5 class="ml-3">TCM  Module Tool:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'tool-list', in_array('tool-list',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'toolli']); !!}
                        <label for="toolli">List Tool</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'tool-create', in_array('tool-create',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'toolcr']); !!}
                        <label for="toolcr">Create Tool</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'tool-edit', in_array('tool-edit',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'tooled']); !!}
                        <label for="tooled">Edit Tool</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'tool-delete', in_array('tool-delete',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'tooldel']); !!}
                        <label for="tooldel">Delete Tool</label>
                    </div>
        ...
        <div class="col-3">
            <h5 class="ml-3">TCM  Module Joint:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'joint-list', in_array('joint-list',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'jointli']); !!}
                        <label for="jointli">List Joint</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'joint-create', in_array('joint-create',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'jointcr']); !!}
                        <label for="jointcr">Create Joint</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'joint-edit', in_array('joint-edit',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'jointed']); !!}
                        <label for="jointed">Edit Joint</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'joint-delete', in_array('joint-delete',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'jointdel']); !!}
                        <label for="jointdel">Delete Joint</label>
                    </div>
        ...
        <div class="col-3">
            <h5 class="ml-3">TTMS  Module Calibration:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'calibration-list', in_array('calibration-list',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'calibrationli']); !!}
                        <label for="calibrationli">List Calibration</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'calibration-create', in_array('calibration-create',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'calibrationcr']); !!}
                        <label for="calibrationcr">Create Calibration</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'calibration-edit', in_array('calibration-edit',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'calibrationed']); !!}
                        <label for="calibrationed">Edit Calibration</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'calibration-delete', in_array('calibration-delete',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'calibrationdel']); !!}
                        <label for="calibrationdel">Delete Calibration</label>
                    </div>
        ...
        <div class="col-3">
            <h5 class="ml-3">TTMS  Module Notifications:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'notification-email-list', in_array('notification-email-list',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'notificationemailli']); !!}
                        <label for="notificationemailli">List Email </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'notification-email-create', in_array('notification-email-create',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'notificationemaicr']); !!}
                        <label for="notificationemaicr">Create Email </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'notification-email-edit', in_array('notification-email-edit',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'notificationemaied']); !!}
                        <label for="notificationemaied">Edit Email </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'notification-email-delete', in_array('notification-email-delete',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'notificationemaidel']); !!}
                        <label for="notificationemaidel">Delete Email </label>
                    </div>
        ...
        <div class="col-3">
            <h5 class="ml-3">Trend-Chart Values:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'trendchart-value-list', in_array('trendchart-value-list',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'trendchartvalueli']); !!}
                        <label for="trendchartvalueli">List  Chart values</label>
                    </div>

                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'trendchart-value-edit', in_array('trendchart-value-edit',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'trendchartvalueed']); !!}
                        <label for="trendchartvalueed">Edit  Chart values</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'trendchart-value-delete', in_array('trendchart-value-delete',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'trendchartvaluedel']); !!}
                        <label for="trendchartvaluedel">Delete  Chart values</label>
                    </div>
        ...
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'trendchart-report', in_array('trendchart-report',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'trendchartreport']); !!}
                        <label for="trendchartreport">Trend Chart Report</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'ttms-schedule-list', in_array('ttms-schedule-list',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'ttmsschedulelist']); !!}
                        <label for="ttmsschedulelist">Calendar List</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'ttms-schedule-calendar', in_array('ttms-schedule-calendar',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'ttmsschedulecalendar']); !!}
                        <label for="ttmsschedulecalendar">Schedule Calendar</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'ttms-action-plan', in_array('ttms-action-plan',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'ttmsactionplan']); !!}
                        <label for="ttmsactionplan">Action Plan</label>
                    </div>
...
<div class="row">
            ...
            <div class="card-body">
				...
				<div class="mb-2">
                    {!! Form::checkbox('permissions[]', 'plant-attendance', in_array('plant-attendance',$perms),
                        [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'plattend']); !!}
    ...
    <div class="row">
        <div class="col-3">
            <h5 class="ml-3">General Settings:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">

                <div class="card-body">
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-settings-auditreporting', in_array('gca-settings-auditreporting',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'auditreporting']); !!}
                        <label for="auditreporting">Audit Reporting</label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-settings-weighingstandards', in_array('gca-settings-weighingstandards',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'weighingstandards']); !!}
                        <label for="weighingstandards">Weighting </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-settings-steps', in_array('gca-settings-steps',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'steps']); !!}
                        <label for="steps">Steps </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-settings-target', in_array('gca-settings-target',$perms),
        ...
        <div class="col-3">
            <h5 class="ml-3">CV Settngs:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">

                <div class="card-body">
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-cv-settings-instructions', in_array('gca-cv-settings-instructions',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'cvinstructions']); !!}
                        <label for="cvinstructions">Instructions </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-cv-settings-inspectionitems', in_array('gca-cv-settings-inspectionitems',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'cvinspectionitem']); !!}
                        <label for="cvinspectionitem">Inspection Items</label>
                    </div>

                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-cv-settings-inspectioncategory', in_array('gca-cv-settings-inspectioncategory',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'cvinspectioncategory']); !!}
                        <label for="cvinspectioncategory">Inspection  Category </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-cv-settings-checksheetitem', in_array('gca-cv-settings-checksheetitem',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'cvchecksheetitem']); !!}
                        <label for="cvchecksheetitem">Checksheet Item</label>
                    </div>
        ...
        <div class="col-3">
            <h5 class="ml-3">LCV Settngs:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">

                <div class="card-body">
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-lcv-settings-instructions', in_array('gca-lcv-settings-instructions',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'lcvinstructions']); !!}
                        <label for="lcvinstructions">Instructions </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-lcv-settings-inspectionitems', in_array('gca-lcv-settings-inspectionitems',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'lcvinspectionitem']); !!}
                        <label for="lcvinspectionitem">Inspection Items</label>
                    </div>

                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-lcv-settings-inspectioncategory', in_array('gca-lcv-settings-inspectioncategory',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'lcvinspectioncategory']); !!}
                        <label for="lcvinspectioncategory">Inspection  Category </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-lcv-settings-checksheetitem', in_array('gca-lcv-settings-checksheetitem',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'lcvchecksheetitem']); !!}
                        <label for="lcvchecksheetitem">Checksheet Item</label>
                    </div>
        ...
        <div class="col-3">
            <h5 class="ml-3"> Reports:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">
                <div class="card-body">
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-report-defects', in_array('gca-report-defects',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'gcadefects']); !!}
                        <label for="gcadefects">Defect</label>
                    </div>

                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'gca-report-dpvwdpv', in_array('gca-report-dpvwdpv',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'gcawdpv']); !!}
                        <label for="gcawdpv"> DPV & WDPV  </label>
                    </div>
    ...
    <div class="row">
        <div class="col-3">
            <h5 class="ml-3">Material List  Module:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">

                <div class="card-body">
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-list-list', in_array('material-management-list-list',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'material-management-list-list']); !!}
                        <label for="material-management-list-list">Manage List </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-list-create', in_array('material-management-list-create',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'material-management-list-create']); !!}
                        <label for="material-management-list-create">Create List  </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-list-edit', in_array('material-management-list-edit',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'material-management-list-edit']); !!}
                        <label for="material-management-list-edit">Edit List </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-list-delete', in_array('material-management-list-delete',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'material-management-list-delete']); !!}
                        <label for="material-management-list-delete">Delete List</label>
                    </div>
        ...
        <div class="col-3">
            <h5 class="ml-3">Models  Module:</h5>
        <div class="col-lg-12">
            <div class="card border-left border-right border-info">

                <div class="card-body">
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-model-list', in_array('material-management-list-list',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'material-management-model-list']); !!}
                        <label for="material-management-model-list">List </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-model-create', in_array('material-management-model-create',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'material-management-model-create']); !!}
                        <label for="material-management-model-create">Create  </label>
                    </div>
                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-model-edit', in_array('material-management-model-edit',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'material-management-model-edit']); !!}
                        <label for="material-management-model-edit">Edit </label>
                    </div>

                    <div class="mb-2">
                        {!! Form::checkbox('permissions[]', 'material-management-model-delete', in_array('material-management-model-delete',$perms),
                            [ 'class' => 'material-inputs chk-col-cyan', 'id'=>'material-management-model-delete']); !!}
                        <label for="material-management-model-delete">Delete  </label>
                    </div>
