...
<div>
    @if($rounting_categories->total_options==6)
    <table class="table ">
    ...
    @php
        ...
        if($rounting_categories->total_options==2){
            $option='Greater Than (>) ';

        }else if($rounting_categories->total_options==3){
            $option='Less Than (<)';

        }else if($rounting_categories->total_options==4){
            $option='Greater Than or Equals To (>=)';

        }else if($rounting_categories->total_options==5){
            $option='Less Than or Equals To (<=)';
