                    ...
                    <div class="col-lg-12">
                        <div class="card ">
                            <div class="card-header bg-danger">
                             ...
                             {{ Form::open(['route' => 'additionalquery', 'class' => 'form-horizontal','files' => true, 'role' => 'form', 'method' => 'post', 'id' => 'create-query'])}}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                         ...
                                                         {!! Form::select('quiz_type', ['single'=>'Single Answer','multiple'=>'Multiple Answer','numeric'=>'Numerical Answer','traceable'=>'Traceable Answer','others'=>'Others'],  $routing_query->quiz_type, ['placeholder' => 'Quiz Type', 'class' => 'form-control custom-select ','id'=>'quiz_type']); !!}
  ...
  <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                         ...
                                                         <input type="text" name="answer[]" id="option-{{$i}}" 
                                            class="form-control" value="{{$quizanswer['option_value']}}" placeholder="Options {{$i}}">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                         ...
                                                         {!! Form::select('can_sign[]', ['No'=>'No','Yes'=>'Yes'],  $items->can_sign, ['placeholder' => 'User To Sign', 'class' => 'form-control custom-select ']); !!}
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        {!! Form::select('additional_field[]', ['No'=>'No','Yes'=>'Yes'],  $items->additional_field, ['placeholder' => 'Additional Field', 'class' => 'form-control custom-select ']); !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    {!! Form::textarea('query_name[]', $items->query_name, ['placeholder' => 'Query Name', 'rows' => 3, 'class' => 'form-control']); !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
