 ...
 <label class="control-label text-right col-md-3">Total Options</label>
                                    <div class="col-md-9">
                                    <select name="total_options" class="form-control custom-select" id="load_options">
...
$('#load_options').change(function() {

   
       show_quiz_option_form();
...
function show_quiz_option_form() {
    ...
    $.ajax({
        ...
        dataType: 'html',
        data: { load_options: $('#load_options').val(),  quiz_type: $('#quiz_type').val(), action: action },
