...
<div class="row page-titles">
    <div class="col-md-5 col-12 align-self-center">
        <h3 class="text-themecolor mb-0">YESTERDAY'S PEOPLE ATTENDANCE SUMMARY REPORT</h3>
    ...
    <div class="col-7">
     ...
     <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-block"><h4>YESTERDAY'S PEOPLE ATTENDANCE REPORT SUMMARY ({{\Carbon\Carbon::yesterday()->format('j M Y')}})</h4>
                        ...
                        <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td>#</td>
                                                        <td>YTD CUM STD HOURS GENERATED:</td>
                                                    ...
                                                    <tr>
                                                        <td>#</td>
                                                        <td>MTD CUM DIRECT HOURS ABSENT:</td>
                                                        <td>???</td>
                                                    </tr>
                                                    <tr>
                                                        <td>#</td>
