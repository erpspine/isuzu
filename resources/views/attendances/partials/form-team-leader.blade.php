    ...
    <td>
        <div class="input-group">
            ...
            <input type="text" name="indirect_hrs[]" class="form-control normalhrs hrs" autocomplete="off"
                placeholder="Indirect" id="indirect_{{ $num }}" value="{{ $indirect }}" required>
        </div>
    </td>
    <td>
        <div class="input-group">
...
@else
    ...
    <tr>
        ...
        <td>
            <div class="input-group">
                <input type="text" name="direct_hrs[]" class="form-control normalhrs hrs"  value="{{ (float)$item->direct_hrs }}"  autocomplete="off" placeholder="Direct"
                    id="direct_{{ $num }}" required>
                <input type="text" name="indirect_hrs[]" class="form-control normalhrs hrs" autocomplete="off"
                    placeholder="Indirect" id="indirect_{{ $num }}" value="{{ (float)$item->indirect_hrs }}" required>
            </div>
        </td>
        <td>
            <div class="input-group">
                <input type="text" id="overtime_{{ $num }}" value="{{ (float)$item->othours }}"  name="othours[]" class="form-control hrs"
                    autocomplete="off" placeholder="Direct" required>
                <input type="text" id="indovertime_{{ $num }}" name="indirect_othours[]"  value="{{ (float)$item->indirect_othours }}"  class="form-control hrs"
                    autocomplete="off" placeholder="Indirect" required>
            </div>
        </td>
        <td>
            <div class="input-group">
                <input type="text" name="auth_othrs[]"
                    class="form-control" id="authhrs_{{$num}}"  value="{{ (float)$item->auth_othrs }}"
                    placeholder="Hours"
                    aria-describedby="basic-default-password" autocomplete="off" required />
                <span class="input-group-text cursor-pointer">
                    <i class="mdi mdi-clipboard-text assetdetails"></i>
