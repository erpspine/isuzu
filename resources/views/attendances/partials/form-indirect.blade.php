@if ($marked == 'Not marked')
    ...
    <tr>
        ...
        <td>
            <input type="hidden" name="direct_hrs[]" class="form-control normalhrs hrs" autocomplete="off" placeholder="Direct"
                id="direct_{{ $num }}" value="0" required>
            <input type="text" name="indirect_hrs[]" id="indirect_{{ $num }}" value="{{ $indirect }}"
                class="form-control normalhrs hrs" autocomplete="off" placeholder="Indirect">
        </td>
        <td>
            <input type="hidden" id="overtime_{{ $num }}" name="othours[]" class="form-control hrs"
        ...
        <td>
            <div class="input-group">
                <input type="text" name="auth_othrs[]" class="form-control" id="authhrs_{{ $num }}"
...
@else
    ...
    <tr>
        ...
        <td>
            ...
            <input type="hidden" name="direct_hrs[]" class="form-control normalhrs hrs" autocomplete="off"
                placeholder="Direct" id="direct_{{ $num }}" value="0" required>
            <input type="text" name="indirect_hrs[]" id="indirect_{{ $num }}" value="{{ $item->indirect_hrs }}"
                class="form-control normalhrs hrs" autocomplete="off" placeholder="Indirect">
        </td>
        <td>
            <input type="hidden" id="overtime_{{ $num }}" name="othours[]" class="form-control hrs"
                autocomplete="off" placeholder="Direct" value="0" required>
            <input type="text" id="indovertime_{{ $num }}" name="indirect_othours[]"
                class="form-control hrs" autocomplete="off" value="{{ (float)$item->indirect_othours }}" placeholder="Indirect" required>
        </td>
        <td>
            <div class="input-group">
                <input type="text" name="auth_othrs[]" class="form-control" id="authhrs_{{ $num }}"
                value="{{ (float)$item->auth_othrs }}"  placeholder="Hours" aria-describedby="basic-default-password" />
                <span class="input-group-text cursor-pointer">
                    <i class="mdi mdi-clipboard-text assetdetails"></i>
                </span>
            </div>
