    ...
    @while($details['qty'] > 0)
        ...
        <div style="display:inline-block;vertical-align:middle;line-height:16px !important;">
            {{-- Business Name --}}
                ...
                <b style="display: block !important" class="text-uppercase">Lot No:{{$details['details']->lot_no}} Job No: {{$details['details']->job_no}}</b>
            ...
            <br>
            {{-- Barcode --}}
            <img class="center-block" style="max-width:90%; !important;height: {{$barcode_details->height*0.6}}in !important;" src="data:image/png;base64,{{DNS1D::getBarcodePNG($details['details']->vin_no, 'C128', 3,30,array(39, 48, 54))}}">
