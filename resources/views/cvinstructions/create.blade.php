...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h3 class="text-themecolor mb-0">Static Instruction</h3>
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Static Instruction</li>
            </ol>
        </div>
    ...
    <div class="container-fluid">
        <div class="content-header row pb-1">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="mb-0">Static Instruction </h3>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(['route' => 'cvinstruction.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-cvzones']) }}
                        {{ Form::hidden('car_type', 'cv', ['class' => 'form-control', 'placeholder' => 'Note', 'required' => 'required', 'autocomplete' => 'off','file'=>true]) }}
                        <div class="card-body">
                            @include('cvinstructions.form')
                            <hr>
                            <div class="card-body">
            ...
            hide: function(deleteElement) {
                if (confirm('Are you sure you want to delete this element?')) {
                    $(this).slideUp(deleteElement);
                      ...
                      $('.procedures-repeater, .procedures-default').repeater({
            show: function() {
                $(this).slideDown();
                $(this).find('.select2').select2();
                // Feather Icons
