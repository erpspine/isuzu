...
@extends('layouts.app')
@section('title','Parts By Bin Location ')
...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h3 class="text-themecolor mb-0">Parts By Bin Location</h3>
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Parts By Bin Location</li>
            </ol>
        </div>
  ...
  <div class="content-header row pb-1">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="mb-0">Parts By Bin Location</h3>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered" id="parts_by_bin">
                            <thead>
                                <tr>
