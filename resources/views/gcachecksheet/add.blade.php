@extends('layouts.app')
@section('title', 'Add Query To Checksheet')
@section('content')
    <!-- ============================================================== -->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card ">
                    ...
                    {{ Form::open(['route' => 'qcaadditionalquery', 'class' => 'form-horizontal', 'files' => true, 'role' => 'form', 'method' => 'post', 'id' => 'create-query']) }}
                    ...
                    <div class="form-body">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::text('query_code', $routing_query->query_code, [
                                                'placeholder' => 'BS-MF101',
                                                'class' => 'form-control',
                                            ]) !!}
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::text('category_name', $routing_query->category_name, [
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            {!! Form::select('vehicle_type', ['1' => 'Light Commercial', '2' => 'Heavy Commercial'], $routing_query->vehicle_type, [
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::select('status', ['Active' => 'Active', 'Inactive' => 'Inactive'], $routing_query->status, [
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="control-label text-right col-md-4">Audit Category</label>
                                        <div class="col-md-8">
                                            {!! Form::select('gca_audit_report_category_id', $gcacat, $routing_query->gca_audit_report_category_id, [
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" name="icon" class="custom-file-input"
                                                        id="icon" accept="image/png, image/gif, image/jpeg">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::select(
                                                ...
                                                [
                                                    ...
                                                    'traceable' => 'Traceable Answer',
                                                    'others' => 'Others',
                                                ],
                                                $routing_query->quiz_type,
                                                ['placeholder' => 'Quiz Type', 'class' => 'form-control custom-select ', 'id' => 'quiz_type'],
                                            ) !!}
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        @elseif($routing_query->quiz_type == 'multiple')
                                            ...
                                            <div class="col-md-9">
                                                {!! Form::select(
                                                    ...
                                                    $routing_query->total_options,
                                                    ['placeholder' => 'Select Options', 'class' => 'form-control custom-select ', 'id' => 'load_options_multiple'],
                                                ) !!}
                                            </div>
                                        @elseif($routing_query->quiz_type == 'numeric')
                                            ...
                                            <div class="col-md-9">
                                                {!! Form::select(
                                                    ...
                                                    $routing_query->total_options,
                                                    ['placeholder' => 'Select Options', 'class' => 'form-control custom-select ', 'id' => 'load_options_numeric'],
                                                ) !!}
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="card-body bg-light">
                                        <div class="row">
                                            ...
                                            @foreach ($quizanswers as $quizanswer)
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">Defect
                                                            {{ $i }}</label>
                                                        <div class="col-md-9">
                                                            <input type="text" name="answer[]"
                                                                id="option-{{ $i }}" class="form-control"
                                                                value="{{ $quizanswer['option_value'] }}"
                                                                placeholder="Defect {{ $i }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                @php
                                    ...
                                    <div class="card-body bg-light">
                                        <div class="row">
                                            ...
                                            @foreach ($quizanswers as $quizanswer)
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">Options
                                                            {{ $i }}</label>
                                                        <div class="col-md-9">
                                                            <input type="text" name="answer[]"
                                                                id="option-{{ $i }}" class="form-control"
                                    ...
                                    <div class="card-body bg-light">
                                        <div class="row">
                                            @if ($routing_query->total_options == 6)
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">Lower
                                                            Limit</label>
                                                        <div class="col-md-9">
                                                            <input type="number" name="lower_limit[]" id="lower_limit"
                                                                class="form-control" value="{{ $mindata[0] }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="control-label text-right col-md-3">Upper
                                                            Limit</label>
                                                        <div class="col-md-9">
                                                            <input type="number" value="{{ $maxdata[0] }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="number"
                                                            value="{{ $routing_query->correct_answers }}"
                                                            name="correct_answers" id="correct_answers"
                            ...
                            <div id="main_product">
                                <div class="product">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        {!! Form::select('can_sign[]', ['No' => 'No', 'Yes' => 'Yes'], $items->can_sign, [
                                                            'placeholder' => 'User To Sign',
                                                            'class' => 'form-control custom-select ',
                                                        ]) !!}
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">Additional
                                                        Field</label>
                                                    <div class="col-md-9">
                                                        {!! Form::select('additional_field[]', ['No' => 'No', 'Yes' => 'Yes'], $items->additional_field, [
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        {!! Form::textarea('query_name[]', $items->query_name, [
                                        ...
                                        <!--/row-->
                                        <button class="btn btn-danger v_delete_temp m-1 align-content-end"><i
        ...
        <script type="text/javascript">
            ...
            function show_quiz_option_multiple_form() {
                ...
                $.ajax({
                    ...
                    dataType: 'html',
                    data: {
                        load_options: $('#load_options_multiple').val(),
                        quiz_type: $('#quiz_type').val(),
                        action: action
                    },
                    success: function(result) {
            ...
            function show_quiz_option_numeric_form() {
                ...
                $.ajax({
                    ...
                    dataType: 'html',
                    data: {
                        load_options: $('#load_options_numeric').val(),
                        quiz_type: $('#quiz_type').val(),
                        action: action
                    },
                    success: function(result) {
