                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="media width-250 float-right">
                        ...
                        <div class="media-body media-right text-right">
                            @include('drltarget.partial.drltarget-header-buttons')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                     {{ Form::open(['route' => 'drltarget.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-drr'])}}
               ...
               <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                             {{ Form::text('target_name', null, ['class' => 'form-control', 'placeholder' => 'E.g Q1 2022','required'=>'required','autocomplete'=>'off']) }}    
                        </div>
                    </div>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                             {{ Form::text('plant_target', null, ['class' => 'form-control', 'placeholder' => 'E.g 90','required'=>'required','autocomplete'=>'off']) }}    
                        </div>
                    </div>
                    <div class="form-group row">
