...
<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
    ...
    @if(Auth()->User()->can('schedule-list') || Auth()->User()->can('schedule-create') || Auth()->User()->can('qualityrpt-position') || Auth()->User()->can('schedule-print')|| Auth()->User()->can('swap-create') || Auth()->User()->can('swap-list') || Auth()->User()->can('prod-sche') || Auth()->User()->can('fcw-sche')|| Auth()->User()->can('hist-sche') || Auth()->User()->can('Effny-dashboard') || Auth()->User()->can('performance-tack') || Auth()->User()->can('buffer-status') || Auth()->User()->can('actual-production') || Auth()->User()->can('qualityrpt-position'))
        ...
        @if(Auth()->User()->can('routing-list') || Auth()->User()->can('routing-create')|| Auth()->User()->can('routing-bymodel') || Auth()->User()->can('swap-create') || Auth()->User()->can('swap-list') || Auth()->User()->can('drr-list') || Auth()->User()->can('defect-list') || Auth()->User()->can('gca-score')|| Auth()->User()->can('reroute-list')|| Auth()->User()->can('reroute-create') || Auth()->User()->can('drltgt-list') || Auth()->User()->can('drltgt-create')|| Auth()->User()->can('drrtgt-list')|| Auth()->User()->can('drrtgt-create') || Auth()->User()->can('mangca-target') || Auth()->User()->can('sort-routing'))
        <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i>
            <span class="hide-menu">Quality</span></li>
            @if(Auth()->User()->can('routing-list') || Auth()->User()->can('routing-create')|| Auth()->User()->can('routing-bymodel')|| Auth()->User()->can('sort-routing'))
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    href="javascript:void(0)" aria-expanded="false"><i
                ...
                @endcan
				@can('sort-routing')
				 <li class="sidebar-item"><a href="{{route('sortroutingquery')}}" class="sidebar-link"><i
                    class="mdi mdi-chart-scatterplot-hexbin"></i> <span class="hide-menu">
        ...
        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
            href="javascript:void(0)" aria-expanded="false"><i
                class="mdi mdi-apple-keyboard-command"></i><span class="hide-menu">Unit Management</span></a>
             <ul aria-expanded="false" class="collapse first-level">
                @can('defect-list')
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="{{route('defectsummary')}}" aria-expanded="false"><i class="mdi mdi-close-box"></i><span
                            class="hide-menu">Defects List</span></a></li>
            @endcan
            @can('drr-list')
                 <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="{{route('drrlist')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
                            class="hide-menu">DRR  List</span></a></li>
            @endcan
            @can('gca-score')
    ...
    @if(Auth()->User()->can('qualityrpt-marked') || Auth()->User()->can('defect-list') || Auth()->User()->can('drr-list') || Auth()->User()->can('drl-report')|| Auth()->User()->can('drl-report'))
            ...
            <ul aria-expanded="false" class="collapse first-level">
                ...
                @can('drl-report')
                    <li class="sidebar-item"><a href="{{route('drl',[''.encrypt_data('plant').'',''.encrypt_data('today').'',''.encrypt_data(''.this_day().'').''])}}" class="sidebar-link"><i
                        class="mdi mdi-backup-restore"></i> <span class="hide-menu">
                        Direct Run Loss</span></a></li>
                @endcan
                @can('drr-report')
                    <li class="sidebar-item"><a href="{{route('drr',[''.encrypt_data('plant').'',''.encrypt_data('today').'',''.encrypt_data(this_day()).''])}}" class="sidebar-link"><i
                        class="mdi mdi-backup-restore"></i> <span class="hide-menu">
                        Direct Run Rate</span></a></li>
                @endcan
				
				<li class="sidebar-item"><a href="{{route('searchunitprofile')}}" class="sidebar-link"><i
                    class="mdi mdi-backup-restore"></i> <span class="hide-menu">
			...
			@if(Auth()->User()->can('drltgt-list') || Auth()->User()->can('drltgt-create')|| Auth()->User()->can('drrtgt-list')|| Auth()->User()->can('drrtgt-create') || Auth()->User()->can('mangca-target') || Auth()->User()->can('gcatgt-create'))
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    href="javascript:void(0)" aria-expanded="false"><i
                        class="mdi mdi-target"></i><span class="hide-menu">QualityTargets</span></a>
                    <ul aria-expanded="false" class="collapse first-level">
                @can('drltgt-list')
                    <li class="sidebar-item"><a href="{{route('drltarget.index')}}" class="sidebar-link"><i
                        class="mdi mdi-chart-line"></i> <span class="hide-menu">
                        Manage DRL Target</span></a></li>
                @endcan
                @can('drltgt-create')
                    <li class="sidebar-item"><a href="{{route('drltarget.create')}}" class="sidebar-link"><i
                        class="mdi mdi-chart-scatterplot-hexbin"></i> <span class="hide-menu">
                        Create DRL Target </span></a></li>
                @endcan
                @can('drrtgt-list')
                    <li class="sidebar-item"><a href="{{route('drrtarget.index')}}" class="sidebar-link"><i
                        class="mdi mdi-chart-line"></i> <span class="hide-menu">
                        Manage DRR Target</span></a></li>
                @endcan
                @can('drrtgt-create')
                    <li class="sidebar-item"><a href="{{route('drrtarget.create')}}" class="sidebar-link"><i
                        class="mdi mdi-chart-scatterplot-hexbin"></i> <span class="hide-menu">
	    ...
	    <!--GCA--->
                @if (Auth()->User()->can('gca-settings-auditreporting') ||
                    ...
                    <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i><span
                            class="hide-menu">GCA</span></li>
                    <li class="sidebar-item {{ ($segment1 == 'gca-audit-report-category') || ($segment1 == 'decrepancy_weight') || ($segment1 == 'gcasteps')   ? 'selected' : '' }}"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-broom"></i><span
                                class="hide-menu">Gca Settings</span></a>
                        <ul aria-expanded="false" class="collapse first-level {{ ($segment1 == 'gca-audit-report-category') || ($segment1 == 'decrepancy_weight') || ($segment1 == 'gcasteps')  ? 'in' : '' }}">
                            ...
                            <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                    href="{{ route('decrepancy_weight.index') }}" aria-expanded="false"><i
                                        class="mdi mdi-fire"></i><span class="hide-menu">Weighting Standards</span></a></li>
                        @endcan
                        @can('gca-settings-steps')
                        <li class="sidebar-item"><a href="{{ route('gcasteps.index') }}"
                                class="sidebar-link"><i class="mdi mdi-chart-line {{ ($segment1 == 'gcasteps') ? 'active' : '' }}"></i> <span
                                    class="hide-menu">
                                    Steps</span></a>
                        </li>
                    @endcan
                ...
                @endcan
                    ...
                    <li class="sidebar-item {{ ($segment1 == 'gcacvchecksheet') || ($segment1 == 'gcacvchecksheetitem') || ($segment1 == 'add-instructions-cv') || ($segment1 == 'appearance-zones-cv-add') || ($segment1 == 'edit-instructions-cv')    ? 'selected' : '' }}"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                        href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-svg"></i><span
                            class="hide-menu">CV Settings</span></a>
                    <ul aria-expanded="false" class="collapse first-level {{ ($segment1 == 'appearance-zones-cv') || ($segment1 == 'gcacvchecksheet') || ($segment1 == 'gcacvchecksheetitem') || ($segment1 == 'add-instructions-cv') || ($segment1 == 'appearance-zones-cv-add') || ($segment1 == 'edit-instructions-cv')  ? 'in' : '' }}">
                ...
                <li class="sidebar-item {{ ($segment1 == 'lcvinstructions') || ($segment1 == 'gcalcvchecksheet') || ($segment1 == 'gcalcvchecksheetitem') || ($segment1 == 'add-instructions-lcv') || ($segment1 == 'appearance-zones-lcv-add')   ? 'selected' : '' }}"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-svg"></i><span
                        class="hide-menu">LCV Settings</span></a>
                <ul aria-expanded="false" class="collapse first-level {{ ($segment1 == 'lcvinstructions') || ($segment1 == 'gcalcvchecksheet') || ($segment1 == 'gcalcvchecksheetitem') || ($segment1 == 'add-instructions-lcv') || ($segment1 == 'appearance-zones-lcv-add')  ? 'in' : '' }}">
            ...
            @endcan
                ...
                @endcan
                        ...
                        <li class="sidebar-item {{ ($segment1 == 'gcadefects-action' || $segment1 == 'gcadpvwdpv') ? 'selected' : '' }}"> <a class="sidebar-link has-arrow waves-effect waves-dark {{ ($segment1 == 'gcapreweek' || $segment1 == 'gcasamplesize') ? 'active' : '' }}"
                            href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-chart-gantt"></i><span
                                class="hide-menu">Gca Report</span></a>
                        <ul aria-expanded="false" class="collapse first-level {{ ($segment1 == 'gcadefects-action' || $segment1 == 'gcadpvwdpv') ? 'in' : '' }}">
                            ...
                            @endcan
                                ...
                                <li class="sidebar-item "><a href="{{ route('gcadpvwdpv') }}"
                                        class="sidebar-link "><i class="mdi mdi-chart-scatterplot-hexbin"></i> <span
                                            class="hide-menu">
                                            DPV & WDPV  </span></a>
                                </li>
		    ...
		    @if(Auth()->User()->can('tool-list') || Auth()->User()->can('tool-create') || Auth()->User()->can('tool-edit') || Auth()->User()->can('tool-delete') || Auth()->User()->can('joint-list') || Auth()->User()->can('joint-create')|| Auth()->User()->can('joint-edit') || Auth()->User()->can('joint-delete') || Auth()->User()->can('calibration-list') || Auth()->User()->can('calibration-create') || Auth()->User()->can('calibration-edit') || Auth()->User()->can('calibration-delete') ||Auth()->User()->can('notification-email-list') || Auth()->User()->can('notification-email-create') || Auth()->User()->can('notification-email-edit') ||Auth()->User()->can('notification-email-delete') || Auth()->User()->can('trendchart-value-list') || Auth()->User()->can('trendchart-value-edit') ||Auth()->User()->can('trendchart-value-delete') ||Auth()->User()->can('trendchart-report') || Auth()->User()->can('ttms-print-cert') || Auth()->User()->can('ttms-schedule-calendar') || Auth()->User()->can('ttms-schedule-list') || Auth()->User()->can('ttms-action-plan') )
 <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i><span class="hide-menu">Torque Management System</span></li>
 <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
    href="javascript:void(0)" aria-expanded="false"><i
    class="mdi mdi-wrench"></i><span class="hide-menu">Torque Calibration  Management System</span></a>
<ul aria-expanded="false" class="collapse first-level">
    @can('tool-list')
    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
        href="{{route('tcm.index')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
            class="hide-menu">Tool Inventory</span></a></li>
 @endcan
    @can('tool-create')
    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
        href="{{route('tcm.create')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
            class="hide-menu">Create Tool</span></a></li>
 @endcan
 @can('joint-list')
 <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
     href="{{route('tcmjoint.index')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
         class="hide-menu">Joint Inventory</span></a></li>
@endcan
 @can('joint-create')
 <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
     href="{{route('tcmjoint.create')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
         class="hide-menu">Create Joint</span></a></li>
@endcan
@can('joint-create')
<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
    href="{{route('importtool')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
        class="hide-menu">Import Tool</span></a></li>
@endcan
...
<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
    href="javascript:void(0)" aria-expanded="false"><i
    class="mdi mdi-shuffle-variant"></i><span class="hide-menu">Calibration</span></a>
<ul aria-expanded="false" class="collapse first-level">
@can('calibration-list')
<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
  href="{{route('qcoscalibration.index')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
      class="hide-menu">Manage</span></a></li>
@endcan
@can('calibration-create')
<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
href="{{route('qcoscalibration.create')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
...
<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
    href="javascript:void(0)" aria-expanded="false"><i
    class="mdi mdi-bell"></i><span class="hide-menu">Emails </span></a>
<ul aria-expanded="false" class="collapse first-level">
@can('notification-email-list')
<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
  href="{{route('qcosemail.index')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
      class="hide-menu">Manage Emails</span></a></li>
@endcan
@can('notification-email-create')
<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
href="{{route('qcosemail.create')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
   class="hide-menu">Create  Emails </span></a></li>
@endcan
</ul>
</li>
...
<li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
    href="javascript:void(0)" aria-expanded="false"><i
    class="mdi mdi-chart-line"></i><span class="hide-menu">TTMS   </span></a>
<ul aria-expanded="false" class="collapse first-level">
@can('trendchart-report')
<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
  href="{{route('qcossheet.index')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
      class="hide-menu">Trend Chart</span></a></li>
@endcan  
@can('trendchart-value-list')
<li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
href="{{route('monitoringsheet.index')}}" aria-expanded="false"><i class="mdi mdi-fire"></i><span
   class="hide-menu">Trend Chart Values </span></a></li>
@endcan
        ...
        @endcan
		     @if (Auth()->User()->can('material-management-list-list') ||
                  ...
                  Auth()->User()->can('material-management-model-create'))
                      ...
                      <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                          href="javascript:void(0)" aria-expanded="false"><i
                              class="mdi mdi-material-ui"></i><span class="hide-menu">Material Management</span></a>
                      <ul aria-expanded="false" class="collapse first-level">
                          @can('material-management-list-list')
                              <li class="sidebar-item"><a href="{{ route('material-distribution.index') }}" class="sidebar-link"><i
                                          class="mdi mdi-arrange-bring-to-front"></i> <span class="hide-menu">
                  ...
                  <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                    href="javascript:void(0)" aria-expanded="false"><i
                        class="mdi mdi-group"></i><span class="hide-menu">Distribution Models</span></a>
                <ul aria-expanded="false" class="collapse first-level">
                    @can('material-management-model-list')
                        <li class="sidebar-item"><a href="{{ route('material-distribution-model.index') }}" class="sidebar-link"><i
                                    class="mdi mdi-arrange-bring-to-front"></i> <span class="hide-menu">
