...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h3 class="text-themecolor mb-0">Update Unit Schedule </h3>
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Update Unit Schedule</li>
            </ol>
        </div>
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="media width-250 float-right">
                        ...
                        <div class="media-body media-right text-right">
                            @include('scheduledbatch.partial.schedulebatch-header-buttons')
                        </div>
                    </div>
                </div>
            </div>
 ...
 <div class="col-12">
               <div class="content-body">
                <div class="card">
                    <div class="card-body">
                        <div class="card-block"><h4>UPDATE SCHEDULE </h4>
