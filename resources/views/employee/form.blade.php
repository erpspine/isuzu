                   ...
                   <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{Form::text('department', 'Manufacturing Operations and Supply Chain', ['class'=>'form-control', 'id'=>'department',
                            'placeholder'=>'Department Name here','autocomplete'=>'off', 'required'=>'required', 'readonly'])}}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="category" class="col-sm-3 text-right control-label col-form-label">Category Name.:</label>
                        <div class="col-sm-9">
                            {{Form::select('category', ['Direct' => 'Direct', 'Indirect' => 'Indirect'], null, array('class'=>'form-control select2',
