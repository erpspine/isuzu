@extends('layouts.app')
@section('title', 'Gca CV Checksheet Item')
@section('content')
    <!-- ============================================================== -->
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h3 class="text-themecolor mb-0">Gca CV Checksheet Item</h3>
    ...
    <div class="container-fluid">
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="media width-250 float-right">
                    <div class="media-body media-right text-right">
                        @include('gcacvchecksheetitem.partial.gcacvchecksheetitem-header-buttons')
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(['route' => 'gcacvchecksheetitem.create', 'class' => 'form-horizontal ', 'files' => true, 'role' => 'form', 'method' => 'get']) }}
                        <div class="row ">
                            @php
                                $cat = [];
                                if (isset($input)) {
                                    ...
                                    <div class="col-md-4 mb-3 mb-md-0">
                                        ...
                                        {!! Form::select(
                                            ...
                                            [
                                                'Paint' => 'Paint',
                                                'Function' => 'Function',
                                                'Functional Weighting Standard' => 'Functional Weighting Standard',
                                                'Label' => 'Label',
                        ...
                        <hr>
                        @if (isset($input))
                            {{ Form::open(['route' => 'gcacvchecksheetitem.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-checksheet']) }}
                            ...
                            @if ($input['query_category'] == 'Paint')
                                @include('gcacvchecksheetitem.sections.paint')
                            @elseif($input['query_category'] == 'Function')
                                @include('gcacvchecksheetitem.sections.function')
                            @elseif($input['query_category'] == 'Functional Weighting Standard')
                                @include('gcacvchecksheetitem.sections.functional_weiging_standard')
                            @elseif($input['query_category'] == 'Label')
                                @include('gcacvchecksheetitem.sections.label')
                            @elseif($input['query_category'] == 'Oil Filling')
                                @include('gcacvchecksheetitem.sections.oilfilling')
                            @elseif($input['query_category'] == 'Lamp')
                                @include('gcacvchecksheetitem.sections.lamp')
                            @elseif($input['query_category'] == 'ZoneABC')
                                @include('gcacvchecksheetitem.sections.zoneabc')
                            @elseif($input['query_category'] == 'ABCD')
                                @include('gcacvchecksheetitem.sections.zoneabcd')
                            @elseif($input['query_category'] == 'No-Zones')
                                @include('gcacvchecksheetitem.sections.nozones')
                            @elseif($input['query_category'] == 'Exterior-Interior')
                                @include('gcacvchecksheetitem.sections.exteriorinterior')
                           @elseif($input['query_category'] == 'ExteriorAB-Interior')
                                @include('gcacvchecksheetitem.sections.exteriorabinterior')
                           @elseif($input['query_category'] == 'Safety')
                                @include('gcacvchecksheetitem.sections.safety')
                        @elseif($input['query_category'] == 'Weight Factor')
                                @include('gcacvchecksheetitem.sections.weightfactor')
                       @elseif($input['query_category'] == 'Fluid-Level')
                                @include('gcacvchecksheetitem.sections.fluidlevel')
                      @elseif($input['query_category'] == 'Noise')
                                @include('gcacvchecksheetitem.sections.noise')
                            @endif
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0 text-right">
                                ...
                                {{ link_to_route('gcacvchecksheet.index', 'Cancel', [], ['class' => 'btn btn-dark waves-effect waves-light']) }}
                            </div>
                        </div>
                        {{ Form::close() }}
                        @endif
        ...
        <script type="text/javascript">
            ...
            $("#gca_stage_id").on('change', function() {
                ...
                $("#query_category_id").select2({
                    ...
                    dropdownAutoWidth: true,
                    ajax: {
                        url: '{{ route('load-gca-query-category') }}',
                        dataType: 'json',
                        type: 'POST',
                        quietMillis: 10,
                        data: {
            ...
            <script type="text/javascript">
                ...
                function defectItemRow(n) {
                    ...
                    if (querycategory == 'Paint') {
                        return `<tr>
<td> <textarea class="form-control" rows="2" placeholder="Quality Zone" name="defect_name[]" id="defect_name-${n}" ></textarea></td>
<td><input type="text" class="form-control " placeholder="Defect Condition" name="defect_condition[]" id="defect_condition-${n}" ></td>
<td class=""> <input type="text" class="form-control " placeholder="Position" name="defect_position[]" id="defect_position-${n}" required></td>
<td> <input name="factor_zero[${n}]" type="checkbox" value="0.5" id="md_checkbox_20" class="chk-col-red mt-2"  /></td>
<td> <input name="factor_one[${n}]" type="checkbox" value="1"  id="md_checkbox_21" class="chk-col-red mt-2"  /></td>
...
`;
                    } else if (querycategory == 'Function') {
                        return `<tr>
                            <td> <textarea class="form-control" rows="2" placeholder="Name" name="defect_name[]" id="defect_name-${n}" ></textarea></td>
<td> <textarea class="form-control" rows="2" placeholder="Description" name="defect_condition[]" id="defect_condition-${n}" ></textarea></td>
<td class=""> <input type="text" class="form-control " placeholder="Position" name="defect_position[]" id="defect_position-${n}" required></td>
<td> <input name="loose[]" type="checkbox" value="Loose" id="md_checkbox_20" class="chk-col-red mt-2"  /></td>
<td> <input name="dermaged[]" type="checkbox" value="Dermaged"  id="md_checkbox_21" class="chk-col-red mt-2"  /></td>
<td> <input name="wrong_assembly[${n}]" type="checkbox" value="Wrongly Assembled"  id="md_checkbox_22" class="chk-col-red mt-2"  /></td>
<td> <input name="lack_of_parts[${n}]" type="checkbox" value="Lack Of Parts"  id="md_checkbox_23" class="chk-col-red mt-2"  /></td>
<td> <input name="function_defect[${n}]" type="checkbox" value="Functional Defects"  id="md_checkbox_24" class="chk-col-red mt-2"  /></td>
<td> <input name="factor_ten[${n}]" type="checkbox" value="10"  id="md_checkbox_25" class="chk-col-red mt-2"  /></td>
<td> <input name="factor_fifty[${n}]" type="checkbox" value="50"  id="md_checkbox_26" class="chk-col-red mt-2"  /></td>
<td><a href="javascript:void(0)" class="text-inverse" title="" data-toggle="tooltip" data-original-title="Delete"><i class="ti-trash remove_item_row"></i></a></td>
</tr>
`;
                    } else if (querycategory == 'Functional Weighting Standard') {
                        return `<tr>
                            <td><input type="text" class="form-control " placeholder="Phenomenon" name="phenomenon[]" id="phenomenon-${n}" ></td>
<td> <textarea class="form-control" rows="2" placeholder="Defect Details" name="defect_name[]" id="defect_name-${n}" ></textarea></td>
<td class=""> <input type="text" class="form-control " placeholder="Position" name="defect_position[]" id="defect_position-${n}" required></td>
<td> <input name="factor_zero[${n}]" type="checkbox" value="0.5" id="md_checkbox_20" class="chk-col-red mt-2"  /></td>
<td> <input name="factor_one[${n}]" type="checkbox" value="1"  id="md_checkbox_21" class="chk-col-red mt-2"  /></td>
<td> <input name="factor_ten[${n}]" type="checkbox" value="10"  id="md_checkbox_25" class="chk-col-red mt-2"  /></td>
...
`;
                    } else if (querycategory == 'Oil Filling') {
                        return `<tr>
                            <td> <textarea class="form-control" rows="3" placeholder="Portion" name="defect_name[]" id="defect_name-${n}" ></textarea></td>
                            <td class=""> <input type="text" class="form-control " placeholder="Position" name="defect_position[]" id="defect_position-${n}" required></td>
...
`;
                    } else if (querycategory == 'Lamp') {
                        return `<tr>
                            <td> <textarea class="form-control" rows="3" placeholder="Defect Name  Name" name="defect_name[]" id="defect_name-${n}" ></textarea></td>
                            <td class=""> <input type="text" class="form-control " placeholder="Position" name="defect_position[]" id="defect_position-${n}" required></td>
<td> <select name="zone_a[${n}]" id="zone_a-${n}" class ="form-control custom-select" Required><option value="">Select</option><option value="0.5">0.5</option><option value="1">1</option><option value="10">10</option><option value="50">50</option></select></td>
<td> <select name="zone_b[${n}]" id="zone_b-${n}" class ="form-control custom-select" Required><option value="">Select</option><option value="0.5">0.5</option><option value="1">1</option><option value="10">10</option><option value="50">50</option></select></td>
<td><a href="javascript:void(0)" class="text-inverse" title="" data-toggle="tooltip" data-original-title="Delete"><i class="ti-trash remove_item_row"></i></a></td>
