...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h3 class="text-themecolor mb-0">Set DRR Target</h3>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                     {{ Form::open(['route' => 'drrtarget.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-drr'])}}
               ...
               <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                             {{ Form::text('target_name', null, ['class' => 'form-control', 'placeholder' => 'E.g Q1 2021','required'=>'required','autocomplete'=>'off']) }}    
                        </div>
                    </div>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                             {{ Form::text('plant_target', null, ['class' => 'form-control', 'placeholder' => 'E.g 20','required'=>'required','autocomplete'=>'off']) }}    
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="cv_target" class="col-sm-3 text-right control-label col-form-label">CV Target</label>
                        <div class="col-sm-9">
                             {{ Form::text('cv_target', null, ['class' => 'form-control', 'placeholder' => 'E.g 80','required'=>'required','autocomplete'=>'off']) }}    
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="lcv_target" class="col-sm-3 text-right control-label col-form-label">LCV Target</label>
                        <div class="col-sm-9">
                             {{ Form::text('lcv_target', null, ['class' => 'form-control', 'placeholder' => 'E.g 80','required'=>'required','autocomplete'=>'off']) }}    
                        </div>
                    </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            {{ Form::text('fromdate', null, ['class' => 'form-control from_date', 'data-toggle'=>'datepicker', 'placeholder' => 'From','required'=>'required','autocomplete'=>'off']) }}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="to" class="col-sm-3 text-right control-label col-form-label">To</label>
                        <div class="col-sm-9">
                            {{ Form::text('todate', null, ['class' => 'form-control to_date', 'data-toggle'=>'datepicker','placeholder' => 'To','required'=>'required','autocomplete'=>'off']) }}
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                             {!! Form::select('active', ['Active'=>'Active','Inactive'=>'Inactive'],  null, ['placeholder' => 'Select Status', 'class' => 'form-control  ']); !!}  
                        </div>
                    </div>                      
                     <hr>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                           ...
                           {{ Form::text('target_value[]', null, ['class' => 'form-control', 'placeholder' => '% Target','required'=>'required','autocomplete'=>'off']) }}
                        </div>
                    </div>
                ...
                success:function(result){
                    if(result.success == true){
                       ...
                       // capital_account_table.ajax.reload();
                        ...
                        location.href = '{{ route("drrtarget.index") }}';
                    }else{
                         $("#submit-data").show();
