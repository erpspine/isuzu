    ...
    <div class="row page-titles" style="background-color:#da251c;">
        <div class="col-md-5 col-12 align-self-center">
            ...
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active text-white">MONTHLY RESPONSIVENESS REPORTS</li>
            </ol>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body analytics-info">
                        {{ Form::open(['route' => 'mnthresponsesummary', 'method' => 'GET'])}}
                        @csrf
                        <div class="row mb-2">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-6">
                                <h4 class="card-title" style="color: indigo; text-transform:uppercase;"><u><b>RESPONSIVENESS BARS - {{$selectedmonth}}</b></u></h4>
                            </div>
                        </div>
                        {{ Form::close() }}
        ...
        var option = {
                ...
                series : [
                    ...
                    },
                    {
                        name:'FCW',
                        type:'bar',
                        data:daysfcw,//[2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 2.3],
