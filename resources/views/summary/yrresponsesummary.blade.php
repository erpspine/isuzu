...
<body>
    ...
    <div class="row page-titles" style="background-color:#da251c;">
        <div class="col-md-5 col-12 align-self-center">
            ...
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active text-white">YEARLY RESPONSIVENESS REPORT</li>
            </ol>
        ...
        <div class="col-md-12">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        {{ Form::open(['route' => 'yrresponsesummary', 'method' => 'GET'])}}
                            @csrf
                            <div class="row">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-8">
                                    <h4 class="card-title" style="color: indigo;"><u><b>RESPONSIVENESS BARS - {{$selectedyr}} </b></u></h4>
                                </div>
                            </div>
                            {{ Form::close() }}
    ...
    // based on prepared DOM, initialize echarts instance
        ...
        var Monthsfcw = <?php echo $Monthsfcw; ?>;
        var Monthsoffline = <?php echo $Monthsoffline; ?>;
                ...
                series : [
                    {
                        name:'Offline',
                        type:'bar',
                        data:Monthsoffline,//[2.0, 4.9, 7.0, 23.2, 25.6, 76.7, 135.6, 162.2, 32.6, 20.0, 6.4, 3.3],

                    },
                    {
                        name:'FCW',
                        type:'bar',
                        data:Monthsfcw,//[2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 2.3],
