    ...
    <div class="row page-titles" style="background-color:#da251c;">
        <div class="col-md-5 col-12 align-self-center">
            ...
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                ...
                <li class="breadcrumb-item active text-white">MONTHLY PEOPLE REPORTS</li>
            </ol>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body analytics-info">
                        {{ Form::open(['route' => 'mnthpeoplesummary', 'method' => 'GET'])}}
                        @csrf
                        <div class="row mb-2">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-6">
                                <h4 class="card-title" style="color: indigo; text-transform:uppercase;"><u><b>{{$selectedshop}} PEOPLE BARS - {{$selectedmonth}}</b></u></h4>
                            </div>
                        </div>
                        {{ Form::close() }}
...
<script>
    ...
    // based on prepared DOM, initialize echarts instance
        ...
        var DaysTLavail = <?php echo $DaysTLavail; ?>;
        var Daysabsentiesm = <?php echo $Daysabsentiesm; ?>;
        var Daysplant_eff = <?php echo $Daysplant_eff; ?>;
                ...
                series : [
                    {
                        ...
                        type:'bar',
                        data:DaysTLavail,//[2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 2.3],

                    },
                    {
                        name:'Absenteeism',
                        type:'bar',
                        data:Daysabsentiesm,//[2.0, 4.9, 7.0, 23.2, 25.6, 76.7, 135.6, 162.2, 32.6, 20.0, 6.4, 3.3],

                    },
                    {
                        name:'Efficiency',
                        type:'bar',
                        data:Daysplant_eff,//[2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 2.3],
