...
@extends('layouts.app')
@section('title','Import Packaging List')
...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-12 align-self-center">
            <h3 class="text-themecolor mb-0">Import Packaging List </h3>
            <ol class="breadcrumb mb-0 p-0 bg-transparent">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Import Packaging List </li>
            </ol>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Import Packaging List</h4>
                        </div>
                        <div class="card-body">
                    ...
                    @endif
                            ...
                            {!! Form::open(['route' => 'packaging-list.store', 'method' => 'post','files' => true, 'class' => 'add-new-user modal-content pt-0', 'id' => 'parts_add_form' ]) !!}
                            <div class="row">
