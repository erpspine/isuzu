    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                     {{ Form::open(['route' => 'gcasteps.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-step'])}}
...
<script type="text/javascript">
     $(document).on('submit', 'form#create-step', function(e){
            e.preventDefault();
            $("#submit-data").hide();
