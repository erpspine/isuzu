                        ...
                        <!-- ============================================================== -->
                    @if(shop() != "noshop")
                        @if(unloggedattendance() > 0 || pendingsubmission() > 0 || reviewwork() > 0 || pendingapproval() > 0)
                                ...
                                <ul class="list-style-none">
                                    ...
                                    <li>
                                        <div class="message-center notifications">
                                            <!-- Message -->
                                            @if(unloggedattendance() > 0)
                                            <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                                <span class="btn btn-danger rounded-circle btn-circle"><i class="fa fa-link"></i></span>
                                                <div class="w-75 d-inline-block v-middle pl-2">
                                                    <h5 class="message-title mb-0 mt-1">({{unloggedattendance();}}) Unlogged Attendance</h5> <span class="font-12 text-nowrap d-block text-muted text-truncate">
                                                        
                                                    </span> <span class="font-12 text-nowrap d-block text-muted"></span> </div>
                                            </a>
                                            @endif
                                            <!-- Message -->
                                            ...
                                            <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                                ...
                                                <div class="w-75 d-inline-block v-middle pl-2">
                                                    <h5 class="message-title mb-0 mt-1">({{pendingsubmission();}}) Pending Submissions</h5> <span class="font-12 text-nowrap d-block text-muted text-truncate">
                                            ...
                                            <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                                ...
                                                <div class="w-75 d-inline-block v-middle pl-2">
                                                    <h5 class="message-title mb-0 mt-1">({{reviewwork();}}) Review Work</h5> <span class="font-12 text-nowrap d-block text-muted text-truncate">
                                            ...
                                            <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                                <span class="btn btn-info rounded-circle btn-circle"><i class="ti-settings"></i></span>
                                                <div class="w-75 d-inline-block v-middle pl-2">
                                                    <h5 class="message-title mb-0 mt-1">({{pendingapproval();}}) Pending Approvals</h5> <span class="font-12 text-nowrap d-block text-muted text-truncate">
                                    ...
                                    <li>
                                        <a class="nav-link border-top text-center text-dark" href="javascript:void(0);"> <strong>Hide notifications</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <ul class="list-style-none">
                                    ...
                                    <li>
                                        <div class="message-center message-body position-relative" style="height:250px;">
                                            <!-- Message 
                                            <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                                <span class="user-img position-relative d-inline-block"> <img src="../assets/images/users/user2.jpg" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle online"></span> </span>
                                                <div class="w-75 d-inline-block v-middle pl-2">
